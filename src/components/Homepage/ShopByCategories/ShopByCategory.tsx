    ...
    <>
      ...
      <div className="categoriesSwiper overflow-x-auto w-full scrollbar-hide">
        <div className="flex gap-[1px] min-w-max">
          {/* category-1 */}
          <Link href="/category/oversized-unisex-tees" className="category  bg-gray-100 w-[300px] lg:w-[500px]  h-[450px] lg:h-[700px] bg-[url('/images/overX3.png')] bg-cover bg-center flex justify-center items-end">
          ...
          {/* category-2 */}
          <Link href="/category/regular-fits" className="category  bg-gray-100 w-[300px] lg:w-[500px]  h-[450px] lg:h-[700px]  bg-[url('/images/fashionTee.png')] bg-cover bg-center flex justify-center items-end">
          ...
          {/* category-3 */}
          <Link href="/category/baby-tees" className="category  bg-gray-100 w-[300px] lg:w-[500px]  h-[450px] lg:h-[700px]  bg-[url('/images/newIn.png')] bg-cover bg-center flex justify-center items-end ">
