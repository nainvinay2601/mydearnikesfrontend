    ...
    <>
      ...
      <div className="categoriesSwiper overflow-x-auto w-full">
        <div className="flex gap-[1px] min-w-max">
          {/* category-1 */}
          <Link href="/category/all-products" className="category relative bg-pink-100 w-[300px] h-[450px] bg-[url('/images/fashionTee.png')] bg-cover bg-center">
          ...
          {/* category-2 */}
          <Link href="/category/hoodies" className="category relative bg-pink-100 w-[300px] h-[450px] bg-[url('/images/accessories.png')] bg-cover bg-center">
            <div className="numberButton font-ispire border-[1px] border-white inline-block px-3 py-1 font-normal text-3xl absolute top-[8px] left-[8px] text-white">
              02
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          {/* category-3 */}
          <Link href="/category/all-products" className="category relative bg-pink-100 w-[300px] h-[450px] bg-[url('/images/newIn.png')] bg-cover bg-center">
            <div className="numberButton font-ispire border-[1px] border-white inline-block px-3 py-1 font-normal text-3xl absolute top-[8px] left-[8px] text-white">
              03
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
          ...
          {/* Category-4 */}
          <Link href="/category/new-arrivals" className="category relative bg-pink-100 w-[300px] h-[450px] bg-[url('/images/fashionTee.png')] bg-cover bg-center">
            <div className="numberButton font-ispire border-[1px] border-white inline-block px-3 py-1 font-normal text-3xl absolute top-[8px] left-[8px] text-white">
              04
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
