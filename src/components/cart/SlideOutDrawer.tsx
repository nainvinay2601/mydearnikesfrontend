...
const CartDrawer = ({ isOpen, onClose }: CartDrawerProps) => {
  ...
  return (
    <>
      ...
      {/* Cart Drawer */}
      <div className={`fixed top-0 right-0 h-[90vh] w-full max-w-md bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        <div className="flex flex-col h-full">
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto px-4 pt-4" style={{ maxHeight: 'calc(100vh - 200px)' }}>
                ...
                <div className="p-4 bg-gray-50">
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="text-xs text-gray-600">
                      Free express shipping. Duties and taxes will be calculated at checkout.
                    </div>
                  </div>
