...
// store/cartStore.ts - REPLACE YOUR EXISTING FILE WITH THIS
...
//   // NEW: Migrate guest cart items (used after login)
...
//       // NEW: Migrate guest cart to logged-in user
...
//             additionalItems += guestItem.quantity;
//           } else {
//             // Add new item
...
//         set({
//           items: mergedItems,
//           totalItems: state.totalItems + additionalItems,
//         });
//       },
//     }),
//     {
