...
export default function CategoryPage({ params }: CategoryPageProps) {
  ...
  const [collection, setCollection] = useState<Omit<
    SimpleCollection,
    "products"
  > | null>(null);
    ...
    <div className="pt-16">
      ...
      >
        ...
        <motion.nav 
          ...
          className="flex gap-2 mt-6 overflow-x-auto scrollbar-hide w-full justify-start md:justify-center relative"
        >
          ...
          {categories.map((cat, index) => {
            ...
            return (
              ...
              >
                <Link
                  href={cat.href}
                  className={`px-4 py-2 text-xs font-medium border rounded-full transition-all duration-200 whitespace-nowrap inline-block ${
                    isActive
