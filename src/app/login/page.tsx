...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:p-8 bg-white">
        <div className="max-w-md w-full space-y-6 lg:space-y-8 py-8 lg:py-0">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
            ...
            <div>
              <label
                htmlFor="email"
                className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5 lg:mb-2"
              >
                Email address
              </label>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-3.5 w-3.5 lg:h-4 lg:w-4 text-gray-900 focus:ring-gray-900 border-gray-300 rounded"
                />
                <label
                  htmlFor="remember-me"
              ...
              <Link
                ...
                className="text-xs sm:text-sm font-medium text-gray-900 hover:text-gray-700"
              >
                Forgot password?
              </Link>
            </div>
